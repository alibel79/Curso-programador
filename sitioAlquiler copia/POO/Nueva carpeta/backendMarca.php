...
?>
			<div class="#fbe9e7 deep-orange lighten-5">
				<form class="col s12" action="backendMarca.php" method="POST">
					...
					<button class="btn waves-effect waves- #3e2723 brown darken-4" type=""> <a href="backendMarca.php">Cancelar</a>
					</button>	
						...
						<th colspan="8">
							<div class="row">
								...
								<div class="col 1 s right">									
									<form class="col 1 s right" action="backendMarca.php" method="GET">	
...
?>
            <tr>
						...
						<td>
							<form action="backendMarca.php" method="POST">
...
?>
          ...
          <tr>
						<td colspan="8">
							<span class="left"><p>Total: <?=$totalMarca?></p> <button class="btn waves-effect waves- #3e2723 brown darken-4" type=""> <a href="backendMarca.php">Listado Completo</a>
					</button></span>
							<ul class="pagination right">
								<li class="waves-effect">
									<a href="backendMarca.php?pag=<?=$PAGINAANTERIOR?>&accion=Buscar&txtBuscar=<?=$BUSCAR?>"><i class="material-icons">chevron_left</i></a>
								</li>
<?php
...
?>
										<li class="<?=$colorear?>">
											<a href="backendMarca.php?pag=<?=$i?>&accion=Buscar&txtBuscar=<?=$BUSCAR?>"><?=$i?></a>
										</li>
<?php 								
								}
?>
								...
								<li class="waves-effect">
									<a href="backendMarca.php?pag=<?=$PAGINASIGUENTE?>&accion=Buscar&txtBuscar=<?=$BUSCAR?>">
